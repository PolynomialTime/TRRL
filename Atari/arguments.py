...
def parse_args():
    ...
    #PongNoFrameskip-v4 QbertNoFrameskip-v4 SpaceInvadersNoFrameskip-v4
    parser.add_argument("--env_name", type=str, default="PongNoFrameskip-v4", help="the environment")
    parser.add_argument("--n_env", type=int, default=1, help="number of parallel envs in venvs")
    parser.add_argument("--discount", type=float, default=0.99, help="discount factor")
    parser.add_argument("--ent_coef", type=float, default=0.01, help="entropy coefficient")
    parser.add_argument("--demo_batch_size", type=int, default=8, help="number of demos to generate")
    ...
    parser.add_argument("--n_reward_updates_per_round", type=int, default=4,
                        help="number of reward udpates per global round")
    parser.add_argument("--n_episodes_adv_fn_est", type=int, default=8,
                        help="number of episodes for advantage function estimation")
    parser.add_argument("--n_timesteps_adv_fn_est", type=int, default=16,
    ...
    parser.add_argument("--transition_truncate_len", type=int, default=32,
                        help="truncate transitions")

    parser.add_argument("--mc_interval", type=int, default=50,
